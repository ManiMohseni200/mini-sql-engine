...
class Parser:
    ...
    def parse(self):
        ...
        if self.current_token() is not None:
            ...
            if self.current_token().type == "WHERE":
                ...
                where = self.parse_condition_expression()
        ...
        if self.current_token() is not None:
            ...
            if self.current_token().type == "LIMIT":

                self.advance()

                limit_token = self.expect("NUMBER")

                if not isinstance(limit_token.value, int):
                    raise ParserError(
    ...
    def parse_order_by(self):
        ...
        if self.current_token() is not None:
            ...
            elif self.current_token().type == "ASC":
